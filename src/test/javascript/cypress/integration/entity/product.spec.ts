...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'invoice leading-edge South' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="keywords"]`).type('stable Crest').should('have.value', 'stable Crest');

      cy.get(`[data-cy="description"]`).type('Buckinghamshire Idaho Visionary').should('have.value', 'Buckinghamshire Idaho Visionary');

      cy.get(`[data-cy="rating"]`).type('93519').should('have.value', '93519');

      cy.get(`[data-cy="dateAdded"]`).type('2022-08-07').should('have.value', '2022-08-07');

      cy.get(`[data-cy="dateModified"]`).type('2022-08-07').should('have.value', '2022-08-07');
