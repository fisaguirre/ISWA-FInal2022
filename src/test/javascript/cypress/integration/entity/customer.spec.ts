...
describe('Customer e2e test', () => {
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      ...
      cy.get(`[data-cy="email"]`).type('Katheryn_Schmitt23@yahoo.com').should('have.value', 'Katheryn_Schmitt23@yahoo.com');

      cy.get(`[data-cy="telephone"]`).type('1-278-363-6888 x254').should('have.value', '1-278-363-6888 x254');
